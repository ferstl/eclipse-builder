...
| Tag | Description |
|:----|:------------|
| `remote-url` | URL of the repository where the listed IUs can be downloaded. The configuration file must contain one or more `remote-url` tags.
...
#### Example 2: Create an Eclipse distribution when the eclipse-builder.sh Script is in a different directory
